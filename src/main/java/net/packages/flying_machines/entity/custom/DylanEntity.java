...
public class DylanEntity extends AnimalEntity {
    public static Object setRelationshipLevel;
    private int blinkTimer = 0;
    private static final int BLINK_INTERVAL = 9 * 20;
    ...
    private static final TrackedData<Integer> HP = DataTracker.registerData(DylanEntity.class, TrackedDataHandlerRegistry.INTEGER);
    ...
    public DylanEntity(EntityType<? extends AnimalEntity> entityType, World world) {
        ...
        this.dataTracker.set(IMMUNE_TO_DAMAGE, false);
    }
    ...
    protected void initDataTracker() {
        ...
        this.dataTracker.startTracking(RELATIONSHIP_LEVEL, 45);
        this.dataTracker.startTracking(IMMUNE_TO_DAMAGE, false);
        this.dataTracker.startTracking(HP, (int) this.getHealth());
    }
